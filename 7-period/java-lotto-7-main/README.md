...
- 1개의 로또를 발행할 때 **중복되지 않는 6개의 숫자**를 뽑는다. -> `Randoms.pickUniqueNumbersInRange(1, 45, 6);`
- 당첨 번호 추첨 시 **중복되지 않는 숫자 6개**와 **보너스 번호 1개**를 뽑는다.
> 보너스 번호는 뽑은 6개 숫자 외의 숫자
- 당첨은 1등부터 5등까지 있다. 당첨 기준과 금액은 아래와 같다.
    ...
    - 4등: 4개 번호 일치 / 50,000원
    - 5등: 3개 번호 일치 / 5,000원
> 당첨 번호와 보너스 번호가 일치한다면 2등은 절대로 안나오므로 (1등이므로) 달라야한다.

- 로또 구입 금액을 입력하면 **구입 금액에 해당하는 만큼 로또를 발행해**야 한다.
...
- 예외 상황 시 **에러 문구를 출력**해야 한다. 단, 에러 문구는 "[ERROR]"로 시작해야 한다.
