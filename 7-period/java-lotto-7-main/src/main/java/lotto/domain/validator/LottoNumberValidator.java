...
import static lotto.util.NumberUtil.isNotBetweenInclusive;

public class LottoNumberValidator {
    private LottoNumberValidator() {
    }

    public static void validateLottoNumber(final int value) {
        validateRange(value);
    }

    private static void validateRange(final int value) {
        if (isNotBetweenInclusive(value, LOTTO_NUMBER_MIN, LOTTO_NUMBER_MAX)) {
