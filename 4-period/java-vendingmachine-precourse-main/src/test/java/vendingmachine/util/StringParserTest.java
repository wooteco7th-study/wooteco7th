...
class StringParserTest {
    ...
    class ParseToInteger {
        ...
        void parseValidNumber() {
            assertThat(StringParser.parseToInteger("123", ErrorMessage.INVALID_AMOUNT)).isEqualTo(123);
        }
        ...
        void parseInvalidNumber(String input) {
            assertIllegalArgument(() -> StringParser.parseToInteger(input, ErrorMessage.INVALID_AMOUNT),
