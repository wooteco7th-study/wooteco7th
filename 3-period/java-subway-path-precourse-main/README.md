...
- **역**, **노선**, **구간 정보**를 초기 설정한다.
- **거리(km)**,**소요 시간(분)**은 양의 정수이다.

#### 지하철역

- **교대역**, **강남역**,**역삼역**, **남부터미널역**,**양재역**, **양재시민의숲역**, **매봉역**이 등록되어 있다.

#### 지하철 노선

- **2호선**,**3호선**,**신분당선**이 등록되어 있다.

#### 구간 정보

- **2호선** = **교대역(2km/3분)** , **강남역(2km/3분)**, **역삼역**
- **3호선** = **교대역(3km/2분)** , **남부터미널역(6m/5분)**, **양재역(1km/1분)**, **매봉역**
- **신분당선** = **강남역(2km/8분)**, **양재역(10km/3분)** , **양재시민의숲역**

### ✅ 경로 조회 기능

- **출발역**,**도착역**을 입력받아 경로를 조회한다,
- 경로 조회 시 **총 거리**, **총 소요시간**도 함께 출력한다.
- 경로 조회 기준은 **최단거리**,**최소시간**이 있다.
